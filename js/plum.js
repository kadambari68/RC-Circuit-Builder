  ...
  jsPlumbUtil = {
    ...
    clone: function (a) {
      if (this.isString(a)) return "" + a;
        ...
        var b = {};
        for (var i in a) b[i] = this.clone(a[i]);
        return b;
      } else return a;
    },
    merge: function (a, b) {
    ...
    copyValues: function (names, from, to) {
      for (var i = 0; i < names.length; i++) to[names[i]] = from[names[i]];
    },
    //
    ...
    pointOnLine: function (fromPoint, toPoint, distance) {
      var m = jsPlumbUtil.gradient(fromPoint, toPoint),
        ...
        segmentMultiplier =
          distance > 0
            ? jsPlumbUtil.segmentMultipliers[s]
            : jsPlumbUtil.inverseSegmentMultipliers[s],
        theta = Math.atan(m),
    ...
    indexOf: function (l, v) {
      return jsPlumbUtil.findWithFunction(l, function (_v) {
        return _v == v;
      });
    },
    ...
    addWithFunction: function (list, item, hashFunction) {
      if (jsPlumbUtil.findWithFunction(list, hashFunction) == -1)
        list.push(item);
    },
      ...
      this.fire = function (event, value, originalEvent) {
        if (!eventsSuspended && _listeners[event]) {
          for (var i = 0; i < _listeners[event].length; i++) {
            ...
            if (
              jsPlumbUtil.findWithFunction(eventsToDieOn, function (e) {
                return e === event;
              }) != -1
            )
    ...
    this.endpointAdded = function (el) {
      ...
      while (p != null && p != b) {
        ...
        if (pid && _draggables[pid]) {
          var idx = -1,
            pEl = jpcl.getElementObject(p),
            pLoc = jpcl.getOffset(pEl);
...
(function () {
  ...
  var _att = function (el, attName) {
      return jsPlumb.CurrentLibrary.getAttribute(_gel(el), attName);
    },
    _setAttribute = function (el, attName, attValue) {
      jsPlumb.CurrentLibrary.setAttribute(_gel(el), attName, attValue);
    },
    _addClass = function (el, clazz) {
      jsPlumb.CurrentLibrary.addClass(_gel(el), clazz);
    },
    _hasClass = function (el, clazz) {
      return jsPlumb.CurrentLibrary.hasClass(_gel(el), clazz);
    },
    _removeClass = function (el, clazz) {
      jsPlumb.CurrentLibrary.removeClass(_gel(el), clazz);
    },
    _gel = function (el) {
    ...
    jsPlumbUIComponent = (window.jsPlumbUIComponent = function (params) {
      ...
      self.hoverClass =
        params.hoverClass ||
        self._jsPlumb.Defaults.HoverClass ||
        jsPlumb.Defaults.HoverClass;
      ...
      this.isDetachAllowed = function (connection) {
        ...
        if (beforeDetach) {
          try {
            ...
            _log("jsPlumb: beforeDetach callback failed", e);
          }
        }
        return r;
      };
      ...
      this.isDropAllowed = function (
        ...
        if (beforeDrop) {
          try {
            ...
            _log("jsPlumb: beforeDrop callback failed", e);
          }
        }
        return r;
      };
      ...
      this.setHover = function (hover, ignoreAttachedElements, timestamp) {
        ...
        if (
          !self._jsPlumb.currentlyDragging &&
          !self._jsPlumb.isHoverSuspended()
        ) {
          _hover = hover;

          if (self.canvas != null) {
            if (self.hoverClass != null) {
              if (hover) jpcl.addClass(self.canvas, self.hoverClass);
              else jpcl.removeClass(self.canvas, self.hoverClass);
            }

            if (hover) jpcl.addClass(self.canvas, self._jsPlumb.hoverClass);
            else jpcl.removeClass(self.canvas, self._jsPlumb.hoverClass);
          }
      ...
      this.bindListeners = function (obj, _self, _hoverFunction) {
        obj.bind("click", function (ep, e) {
          _self.fire("click", _self, e);
        });
        obj.bind("dblclick", function (ep, e) {
          _self.fire("dblclick", _self, e);
        });
        obj.bind("contextmenu", function (ep, e) {
      ...
      this.applyType = function (t, doNotRepaint) {
        ...
        if (t.parameters) {
          for (var i in t.parameters) self.setParameter(i, t.parameters[i]);
        }
      };

      // CSS classes
      this.addClass = function (clazz) {
        if (self.canvas != null) _addClass(self.canvas, clazz);
      };

      this.removeClass = function (clazz) {
        if (self.canvas != null) _removeClass(self.canvas, clazz);
      };
    }),
    overlayCapableJsPlumbUIComponent =
      (window.overlayCapableJsPlumbUIComponent = function (params) {
        ...
        var processOverlay = function (o) {
            ...
            if (_isArray(o)) {
              ...
              var type = o[0],
                ...
                p = jsPlumb.extend(
                  { component: self, _jsPlumb: self._jsPlumb },
                  o[1]
                );
              if (o.length == 3) jsPlumb.extend(p, o[2]);
              _newOverlay = new jsPlumb.Overlays[self._jsPlumb.getRenderMode()][
                type
              ](p);
        ...
        var _internalLabelOverlayId = "__label",
          _makeLabelOverlay = function (params) {
            ...
            return new jsPlumb.Overlays[self._jsPlumb.getRenderMode()].Label(
              mergedParams
            );
          };
        if (params.label) {
          var loc = params.labelLocation || self.defaultLabelLocation || 0.5,
            labelStyle =
              params.labelStyle ||
              self._jsPlumb.Defaults.LabelStyle ||
              jsPlumb.Defaults.LabelStyle;
          this.overlays.push(
            _makeLabelOverlay({
              label: params.label,
              location: loc,
        ...
        this.setLabel = function (l) {
          ...
          if (!self._jsPlumb.isSuspendDrawing()) self.repaint();
        };
        ...
        this.setHover = function (hover, ignoreAttachedElements, timestamp) {
          ...
          for (var i = 0, j = self.overlays.length; i < j; i++) {
            self.overlays[i][hover ? "addClass" : "removeClass"](
              self._jsPlumb.hoverClass
            );
          }
        };
      });
  ...
  var jsPlumbInstance = function (_defaults) {
    ...
    var log = null,
      ...
      _appendElement = function (el, parent) {
        if (_currentInstance.Defaults.Container)
          jsPlumb.CurrentLibrary.appendElement(
            el,
            _currentInstance.Defaults.Container
          );
        else if (!parent) jsPlumbAdapter.appendToRoot(el);
        else jsPlumb.CurrentLibrary.appendElement(el, parent);
      },
      _curIdStamp = 1,
      _idstamp = function () {
        return "" + _curIdStamp++;
      ...
      _draw = function (element, ui, timestamp, clearEdits) {
        ...
        if (!jsPlumbAdapter.headless && !_suspendDrawing) {
          var id = _att(element, "id"),
            repaintEls =
              _currentInstance.dragManager.getElementsForDraggable(id);
      ...
      _initDraggableIfNecessary = function (element, isDraggable, dragOptions) {
        ...
        if (!jsPlumbAdapter.headless) {
          ...
          if (draggable) {
            if (
              jpcl.isDragSupported(element) &&
              !jpcl.isAlreadyDraggable(element)
            ) {
              var options =
                dragOptions ||
                _currentInstance.Defaults.DragOptions ||
      ...
      _prepareConnectionParams = function (params, referenceParams) {
        ...
        if (_p.sourceEndpoint && !_p.sourceEndpoint.addedViaMouse)
          _p.sourceIsNew = false;
        if (_p.targetEndpoint && !_p.targetEndpoint.addedViaMouse)
          _p.targetIsNew = false;
        ...
        if (
          ...
          if (tep) {
            ...
            var newEndpoint =
              existingUniqueEndpoint != null
                ? existingUniqueEndpoint
                : _currentInstance.addEndpoint(_p.target, tep);
            if (_targetEndpointsUnique[tid])
              _targetEndpoints[tid] = newEndpoint;
        ...
        if (
          ...
          if (tep) {
            ...
            var newEndpoint =
              existingUniqueEndpoint != null
                ? existingUniqueEndpoint
                : _currentInstance.addEndpoint(_p.source, tep);
            if (_sourceEndpointsUnique[tid])
              _sourceEndpoints[tid] = newEndpoint;
      ...
      _newConnection = function (params) {
        ...
        if (params.container) params["parent"] = params.container;
        else {
      ...
      _getParentFromParams = function (params) {
        if (params.container) return params.container;
        else {
    ...
    this.isConnectionBeingDragged = function () {
      return _connectionBeingDragged != null;
    };
    this.setConnectionBeingDragged = function (c) {
      _connectionBeingDragged = c;
    };
    ...
    this.addEndpoint = function (el, params, referenceParams) {
      ...
      var results = [],
        inputs =
          _isArray(el) || (el.length != null && !_isString(el)) ? el : [el];

      for (var i = 0, j = inputs.length; i < j; i++) {
        var _el = _gel(inputs[i]),
          id = _getId(_el);
        p.source = _el;
        ...
        var myOffset = offsets[id],
          myWH = sizes[id];
        var anchorLoc = e.anchor.compute({
          xy: [myOffset.left, myOffset.top],
          wh: myWH,
          element: e,
          timestamp: _suspendedAt,
        });
        var endpointPaintParams = {
          anchorLoc: anchorLoc,
          timestamp: _suspendedAt,
        };
    ...
    this.addEndpoints = function (el, endpoints, referenceParams) {
      ...
      for (var i = 0, j = endpoints.length; i < j; i++) {
        ...
        if (_isArray(e)) Array.prototype.push.apply(results, e);
        else results.push(e);
      }
      return results;
    };
    ...
    this.makeAnchor = function () {
      ...
      if (specimen.compute && specimen.getOrientation)
        return specimen; //TODO hazy here about whether it should be added or is already added somehow.
      ...
      //		an array of numbers - this defines a single anchor.
        ...
        if (_isArray(specimen[0]) || _isString(specimen[0])) {
          if (
            specimen.length == 2 &&
            _isString(specimen[0]) &&
            _isObject(specimen[1])
          ) {
            var pp = jsPlumb.extend(
      ...
      _doOne = function (_el) {
        ...
        var dropOptions = jsPlumb.extend({}, p.dropOptions || {}),
          _drop = function () {
            ...
            if (
              !_targetsEnabled[elid] ||
              (_targetMaxConnections[elid] > 0 &&
                targetCount >= _targetMaxConnections[elid])
            ) {
              if (onMaxConnections) {
                onMaxConnections(
                  {
            ...
            if (jpc.suspendedEndpoint) {
              ...
              jpc.target = jpcl.getElementObject(
            ...
            if (_continue) {
              ...
              var newEndpoint =
                _targetEndpoints[elid] || _currentInstance.addEndpoint(_el, p);
              ...
              if (newEndpoint.anchor.positionFinder != null) {
                var dropPosition = jpcl.getUIPosition(
                    arguments,
                    _currentInstance.getZoom()
                  ),
              ...
              var c = _currentInstance.connect({
                ...
                endpointsToDeleteOnDetach: deleteEndpointsOnDetach
                  ? [source, newEndpoint]
                  : null,
                ...
                doNotFireConnectionEvent:
                  source.endpointWillMoveAfterConnection,
              });
              ...
              if (
                jpc.endpoints[1]._makeTargetCreator &&
                jpc.endpoints[1].connections.length < 2
              )
            ...
            // if not allowed to drop...
              ...
              if (jpc.suspendedEndpoint) {
                ...
                } else source.detach(jpc, false, true, true, originalEvent); // otherwise, detach the connection and tell everyone about it.
              }
            }
          };
      ...
      var jpcl = jsPlumb.CurrentLibrary,
        ...
        _doOne = function (_el) {
          ...
          var elid = _getId(_el),
            parentElement = function () {
              return p.parent == null
                ? p.parent
                : p.parent === "parent"
                ? jpcl.getElementObject(jpcl.getDOMElement(_el).parentNode)
                : jpcl.getElementObject(p.parent);
            },
            idToRegisterAgainst =
              p.parent != null ? _currentInstance.getId(parentElement()) : elid;
          ...
          dragOptions[stopEvent] = _wrap(dragOptions[stopEvent], function () {
            ...
            if (ep.connections.length == 0) _currentInstance.deleteEndpoint(ep);
            else {
              ...
              ep.setAnchor(
                _currentInstance.makeAnchor(anchorDef, elid, _currentInstance)
              );
              ...
              if (p.parent) {
                ...
                if (parent) {
                  ...
                  _currentInstance.anchorManager.rehomeEndpoint(
                    currentId,
                    parent
                  );
                  ...
                  _removeWithFunction(
                    connectionsByScope[oldConnection.scope],
                    function (c) {
          ...
          var mouseDownListener = function (e) {
            ...
            if (p.filter) {
              var evt = jpcl.getOriginalEvent(e),
                r = jsPlumbUtil.isString(p.filter)
                  ? selectorFilter(evt, _el, p.filter)
                  : p.filter(evt, _el);
            ...
            var sourceCount = _currentInstance.select({
              source: idToRegisterAgainst,
            }).length;
            if (
              _sourceMaxConnections[idToRegisterAgainst] >= 0 &&
              sourceCount >= _sourceMaxConnections[idToRegisterAgainst]
            ) {
              if (onMaxConnections) {
                onMaxConnections(
                  {
            ...
            var myOffsetInfo = _updateOffset({ elId: elid }).o,
              ...
              x =
                ((e.pageX || e.page.x) / z - myOffsetInfo.left) /
                myOffsetInfo.width,
              y =
                ((e.pageY || e.page.y) / z - myOffsetInfo.top) /
                myOffsetInfo.height,
              parentX = x,
              parentY = y;
            ...
            if (p.parent) {
              ...
              (parentX =
                ((e.pageX || e.page.x) - myOffsetInfo.left) /
                myOffsetInfo.width),
                (parentY =
                  ((e.pageY || e.page.y) - myOffsetInfo.top) /
                  myOffsetInfo.height);
            }
            ...
            if (p.parent) {
              var potentialParent =
                tempEndpointParams.container ||
                _currentInstance.Defaults.Container ||
                jsPlumb.Defaults.Container;
              if (potentialParent)
                tempEndpointParams.container = potentialParent;
              else
                tempEndpointParams.container = jsPlumb.CurrentLibrary.getParent(
                  parentElement()
                );
            }
    ...
    this.unmakeEverySource = function () {
      for (var i in _sourcesEnabled) _currentInstance.unmakeSource(i, true);
    ...
    this.unmakeEveryTarget = function () {
      for (var i in _targetsEnabled) _currentInstance.unmakeTarget(i, true);
    ...
    var _setEnabled = function (type, el, state, toggle) {
      ...
      if (_isString(el)) a[el] = toggle ? !a[el] : state;
        ...
        for (var i = 0, ii = el.length; i < ii; i++) {
          var id = (_el = jsPlumb.CurrentLibrary.getElementObject(el[i])),
            id = _getId(_el);
    ...
    this.repaint = function (el, ui, timestamp) {
      ...
      // ...and single strings.
      else _draw(_gel(el), ui, timestamp);
    ...
    this.registerListener = function (el, type, listener) {
      ...
      _addToList(_registeredListeners, type, {
        el: el,
        event: type,
        listener: listener,
      });
    ...
    this.setId = function (el, newId, doNotSetAttribute) {
      var id = el.constructor == String ? el : _currentInstance.getId(el),
        sConns = _currentInstance.getConnections(
          { source: id, scope: "*" },
          true
        ),
        tConns = _currentInstance.getConnections(
          { target: id, scope: "*" },
          true
        );
    ...
    this.adjustForParentOffsetAndScroll = function (xy, el) {
      ...
      if (offsetParent != null) {
        var po =
            offsetParent.tagName.toLowerCase() === "body"
              ? { left: 0, top: 0 }
              : _getOffset(offsetParent, _currentInstance),
          so =
            offsetParent.tagName.toLowerCase() === "body"
              ? { left: 0, top: 0 }
              : { left: offsetParent.scrollLeft, top: offsetParent.scrollTop };
    ...
    if (!jsPlumbAdapter.headless) {
      _currentInstance.dragManager =
        jsPlumbAdapter.getDragManager(_currentInstance);
...
(function () {
  ...
  jsPlumb.AnchorManager = function (params) {
    var _amEndpoints = {},
      ...
      calculateOrientation = function (
        ...
        var theta = Math.atan2(
          ...
          h =
            (sd.left <= td.left && sd.right >= td.left) ||
            (sd.left <= td.right && sd.right >= td.right) ||
            (sd.left <= td.left && sd.right >= td.right) ||
            (td.left <= sd.left && td.right >= sd.right),
          v =
            (sd.top <= td.top && sd.bottom >= td.top) ||
            (sd.top <= td.bottom && sd.bottom >= td.bottom) ||
            (sd.top <= td.top && sd.bottom >= td.bottom) ||
            (td.top <= sd.top && td.bottom >= sd.bottom),
          possiblyTranslateEdges = function (edges) {
            ...
            return [
              sourceAnchor.isContinuous
                ? sourceAnchor.verifyEdge(edges[0])
                : edges[0],
              targetAnchor.isContinuous
                ? targetAnchor.verifyEdge(edges[1])
                : edges[1],
            ];
          },
          out = {
        ...
        if (!(h || v)) {
          if (td.left > sd.left && td.top > sd.top) out.a = ["right", "top"];
          ...
          placeSomeAnchors = function (
            ...
            if (unsortedConnections.length > 0) {
              ...
              var _setAnchorLocation = function (endpoint, anchorPos) {
                var a = jsPlumbInstance.adjustForParentOffsetAndScroll(
    ...
    var ContinuousAnchor = function (anchorParams) {
      ...
      this.getCurrentLocation = function (endpoint) {
        return (
          userDefinedContinuousAnchorLocations[endpoint.id] ||
          continuousAnchorLocations[endpoint.id] || [0, 0]
        );
      };
  ...
  jsPlumb.Anchor = function (params) {
    ...
    this.compute = function (params) {
      ...
      if (timestamp && timestamp === self.timestamp) return lastReturnValue;

      if (userDefinedLocation != null) {
        lastReturnValue = userDefinedLocation;
      } else {
        lastReturnValue = [
          xy[0] + self.x * wh[0] + self.offsets[0],
          xy[1] + self.y * wh[1] + self.offsets[1],
        ];
        // adjust loc if there is an offsetParent
        lastReturnValue = jsPlumbInstance.adjustForParentOffsetAndScroll(
          lastReturnValue,
          element.canvas
        );
      }
  ...
  jsPlumb.FloatingAnchor = function (params) {
    ...
    this.compute = function (params) {
      ...
      // adjust loc if there is an offsetParent
      result = jsPlumbInstance.adjustForParentOffsetAndScroll(
        result,
        element.canvas
      );
  ...
  jsPlumb.DynamicAnchor = function (params) {
    ...
    var _anchors = [],
      ...
      _convert = function (anchor) {
        return anchor.constructor == jsPlumb.Anchor
          ? anchor
          : params.jsPlumbInstance.makeAnchor(
              anchor,
              params.elementId,
    ...
    this.compute = function (params) {
      ...
      if (_curAnchor != _lastAnchor) self.fire("anchorChanged", _curAnchor);
    ...
    this.getCurrentLocation = function () {
      return (
        self.getUserDefinedLocation() ||
        (_curAnchor != null ? _curAnchor.getCurrentLocation() : null)
      );
    };
  ...
  jsPlumb.Anchors["Assign"] = _curryAnchor(
    0,
    0,
    0,
    0,
  ...
  var _makeConnectionDragHandler = function (placeholder, _jsPlumb) {
    ...
    return {
      drag: function () {
        ...
        var _ui = jsPlumb.CurrentLibrary.getUIPosition(
          arguments,
          _jsPlumb.getZoom()
        );
  ...
  jsPlumb.Endpoint = function (params) {
    ...
    this.getDefaultType = function () {
      return {
        ...
        paintStyle:
          self._jsPlumb.Defaults.EndpointStyle ||
          jsPlumb.Defaults.EndpointStyle,
        endpoint: self._jsPlumb.Defaults.Endpoint || jsPlumb.Defaults.Endpoint,
        hoverPaintStyle:
          self._jsPlumb.Defaults.EndpointHoverStyle ||
          jsPlumb.Defaults.EndpointHoverStyle,
        overlays:
          self._jsPlumb.Defaults.EndpointOverlays ||
    ...
    var visible = true,
      __enabled = !(params.enabled === false);
      ...
      if (!doNotChangeConnections) {
        for (var i = 0; i < self.connections.length; i++) {
          ...
          if (!doNotNotifyOtherEndpoint) {
            ...
            if (self.connections[i].endpoints[oIdx].connections.length == 1)
              self.connections[i].endpoints[oIdx].setVisible(v, true, true);
          }
        }
      }
    };
    ...
    this.areConnectionsDirected = function () {
      return _connectionsDirected;
    };
    this.setConnectionsDirected = function (b) {
      _connectionsDirected = b;
    };
    ...
    var _currentAnchorClass = "",
      _updateAnchorClass = function () {
        jpcl.removeClass(
          _element,
          _jsPlumb.endpointAnchorClassPrefix + "_" + _currentAnchorClass
        );
        self.removeClass(
          _jsPlumb.endpointAnchorClassPrefix + "_" + _currentAnchorClass
        );
    ...
    this.setAnchor = function (anchorParams, doNotRepaint) {
      ...
      if (!doNotRepaint) _jsPlumb.repaint(_elementId);
    };
    ...
    this.setEndpoint = function (ep) {
      ...
      if (_ju.isString(ep)) _endpoint = _e(ep, endpointArgs);
    ...
    this.addConnection = function (connection) {
      ...
      self[(self.connections.length > 0 ? "add" : "remove") + "Class"](
        _jsPlumb.endpointConnectedClass
      );
      self[(self.isFull() ? "add" : "remove") + "Class"](
    ...
    this.detach = function (
      ...
      var idx = _ju.findWithFunction(self.connections, function (c) {
      ...
      if (idx >= 0) {
        ...
        if (
          ...
          var t =
            connection.endpoints[0] == self
              ? connection.endpoints[1]
              : connection.endpoints[0];
          if (
            forceDetach ||
            connection._forceDetach ||
            self.isDetachAllowed(
              connection
            ) /*&& t.isDetachAllowed(connection)*/
          ) {
            ...
            if (!ignoreTarget) {
              ...
              if (connection.endpointsToDeleteOnDetach) {
                for (
                  var i = 0;
                  i < connection.endpointsToDeleteOnDetach.length;
                  i++
                ) {
            ...
            if (connection.getConnector() != null)
              _ju.removeElements(
                connection.getConnector().getDisplayElements(),
                connection.parent
              );
            _ju.removeWithFunction(
              params.connectionsByScope[connection.scope],
              function (c) {
                return c.id == connection.id;
              }
            );
    ...
    this.detachFrom = function (targetEndpoint, fireEvent, originalEvent) {
      ...
      for (var i = 0; i < self.connections.length; i++) {
        if (
          self.connections[i].endpoints[1] == targetEndpoint ||
    ...
    this.setElement = function (el, container) {
      ...
      _ju.removeWithFunction(
        params.endpointsByElement[self.elementId],
        function (e) {
          return e.id == self.id;
        }
      );
      ...
      var newParentElement = params.getParentFromParams({
          source: parentId,
          container: container,
        }),
    ...
    this.connectorSelector = function () {
      ...
      if (self.isTarget && candidate) return candidate;
        ...
        return self.connections.length < _maxConnections ||
          _maxConnections == -1
          ? null
          : candidate;
      }
    ...
    this.isFull = function () {
      return !(
        self.isFloating() ||
        _maxConnections < 1 ||
        self.connections.length < _maxConnections
      );
    };
    ...
    var findConnectionToUseForDynamicAnchor = function (elementWithPrecedence) {
      ...
      if (elementWithPrecedence != null) {
        for (var i = 0; i < self.connections.length; i++) {
          if (
            self.connections[i].sourceId == elementWithPrecedence ||
            self.connections[i].targetId == elementWithPrecedence
          ) {
            idx = i;
            break;
          }
    ...
    this.paint = function (params) {
      ...
      if (!timestamp || self.timestamp !== timestamp) {
        ...
        if (xy) {
          ...
          _endpoint.compute(
            ap,
            self.anchor.getOrientation(self),
            self.paintStyleInUse,
            connectorPaintStyle || self.paintStyleInUse
          );
          ...
          for (var i = 0; i < self.overlays.length; i++) {
            ...
            if (o.isVisible()) {
              self.overlayPlacements[i] = o.draw(
                self.endpoint,
                self.paintStyleInUse
              );
    ...
    if (jpcl.isDragSupported(_element)) {
      ...
      var start = function () {
        ...
        if (params.isSource && self.isFull() && !dragAllowedWhenFull)
          _continue = false;
        ...
        var ipcoel = _gel(inPlaceCopy.canvas),
          ...
          po = _jsPlumb.adjustForParentOffsetAndScroll(
            [ipco.left, ipco.top],
            inPlaceCopy.canvas
          ),
        ...
        // first time.
        if (self.parentAnchor)
          self.anchor = _jsPlumb.makeAnchor(
            self.parentAnchor,
            self.elementId,
            _jsPlumb
          );
        ...
        floatingEndpoint = _makeFloatingEndpoint(
          self.getPaintStyle(),
          self.anchor,
          _endpoint,
          self.canvas,
      ...
      dragOptions[dragEvent] = _jsPlumb.wrap(
        dragOptions[dragEvent],
        _dragHandler.drag
      );
      dragOptions[stopEvent] = _jsPlumb.wrap(
        dragOptions[stopEvent],
        function () {
          var originalEvent = jpcl.getDropEvent(arguments);
          _ju.removeWithFunction(
            params.endpointsByElement[placeholderInfo.id],
            function (e) {
          ...
          if (jpc.endpoints[idx] == floatingEndpoint) {
            ...
            if (existingJpc && jpc.suspendedEndpoint) {
              ...
              _ju.removeElements(
                jpc.getConnector().getDisplayElements(),
                self.parent
              );
          ...
          _ju.removeElements(
            [placeholderInfo.element[0], floatingEndpoint.canvas],
            _element
    ...
    var _initDropTarget = function (canvas, forceInit, isTransient, endpoint) {
      if ((params.isTarget || forceInit) && jpcl.isDropSupported(_element)) {
        ...
        var dropEvent = jpcl.dragEvents["drop"],
          ...
          drop = function () {
            ...
            var redrop =
              ...
              (jpc.suspendedEndpoint.id == self.id ||
                (self.referenceEndpoint &&
                  jpc.suspendedEndpoint.id == self.referenceEndpoint.id));
            if (redrop) {
            ...
            if (jpc != null) {
              ...
              if (
                ...
                var continueFunction = function () {
                  ...
                  if (!jpc.suspendedEndpoint) {
                    if (params.draggable)
                      jsPlumb.CurrentLibrary.initDraggable(
                        self.element,
                        dragOptions,
                        true,
                        _jsPlumb
                  ...
                  if (jpc.endpoints[0].addedViaMouse)
                    jpc.endpointsToDeleteOnDetach[0] = jpc.endpoints[0];
                  if (jpc.endpoints[1].addedViaMouse)
                    jpc.endpointsToDeleteOnDetach[1] = jpc.endpoints[1];
        ...
        dropOptions[overEvent] = _jsPlumb.wrap(
          ...
          function () {
            ...
            if (_jpc != null) {
              ...
              var _cont =
                (self.isTarget && _jpc.floatingAnchorIndex != 0) ||
                (_jpc.suspendedEndpoint &&
                  self.referenceEndpoint &&
                  self.referenceEndpoint.id == _jpc.suspendedEndpoint.id);
              if (_cont) {
                ...
                self[(bb ? "add" : "remove") + "Class"](
                  _jsPlumb.endpointDropAllowedClass
                );
                self[(bb ? "remove" : "add") + "Class"](
        ...
        dropOptions[outEvent] = _jsPlumb.wrap(
    ...
    _initDropTarget(
      _gel(self.canvas),
      true,
      !(params._transient || self.anchor.isFloating),
      self
    );
  ...
  jsPlumb.Connection = function (params) {
    ...
    this.setVisible = function (v) {
      ...
      if (connector && connector.canvas)
        connector.canvas.style.display = v ? "block" : "none";
      self.repaint();
    };
    // END VISIBILITY
    ...
    this.setEditable = function (e) {
      if (connector && connector.isEditable()) editable = e;
    ...
    var _ac = this.addClass,
      _rc = this.removeClass;
    ...
    this.getDefaultType = function () {
      return {
        ...
        paintStyle:
          self._jsPlumb.Defaults.PaintStyle || jsPlumb.Defaults.PaintStyle,
        connector:
          self._jsPlumb.Defaults.Connector || jsPlumb.Defaults.Connector,
        hoverPaintStyle:
          self._jsPlumb.Defaults.HoverPaintStyle ||
          jsPlumb.Defaults.HoverPaintStyle,
        overlays:
          self._jsPlumb.Defaults.ConnectorOverlays ||
    ...
    var makeConnector = function (renderMode, connectorName, connectorArgs) {
      ...
      if (
        ...
        jsPlumb.Connectors[connectorName] == null
      )
        throw {
    ...
    this.setConnector = function (connectorSpec, doNotRepaint) {
      ...
      if (
        ...
        jsPlumb.ConnectorEditors[connector.type] &&
        connector.isEditable()
      ) {
    ...
    if (params.deleteEndpointsOnDetach) {
      if (params.sourceIsNew)
        self.endpointsToDeleteOnDetach[0] = self.endpoints[0];
      if (params.targetIsNew)
        self.endpointsToDeleteOnDetach[1] = self.endpoints[1];
    }
    ...
    if (params.path) connector.setPath(params.path);
    ...
    self.setCost = function (c) {
      _cost = c;
    };
    var directed = params.directed;
    // inherit directed flag if set no source endpoint
    if (params.directed == null)
      directed = self.endpoints[0].areConnectionsDirected();
    self.isDirected = function () {
    ...
    this.moveParent = function (newParent) {
      var jpcl = jsPlumb.CurrentLibrary,
        curParent = jpcl.getParent(connector.canvas);
      ...
      if (connector.reattachListeners)
        // this is for SVG/VML; change an element's parent and you have to reinit its listeners.
    ...
    this.paint = function (params) {
      if (visible) {
        ...
        if (timestamp == null || timestamp != lastPaintedAt) {
          var sourceInfo = _jsPlumb.updateOffset({
              elId: elId,
              offset: ui,
              recalc: recalc,
              timestamp: timestamp,
            }).o,
            targetInfo = _jsPlumb.updateOffset({
              elId: tId,
              timestamp: timestamp,
          ...
          for (var i = 0; i < self.overlays.length; i++) {
            ...
            if (o.isVisible()) {
              ...
              overlayExtents.minX = Math.min(
                overlayExtents.minX,
                self.overlayPlacements[i].minX
              );
              overlayExtents.maxX = Math.max(
                overlayExtents.maxX,
                self.overlayPlacements[i].maxX
              );
              overlayExtents.minY = Math.min(
                overlayExtents.minY,
                self.overlayPlacements[i].minY
              );
              overlayExtents.maxY = Math.max(
                overlayExtents.maxY,
                self.overlayPlacements[i].maxY
              );
            }
          }
          ...
          var lineWidth = parseFloat(self.paintStyleInUse.lineWidth || 1) / 2,
            ...
            extents = {
              xmin: Math.min(
                connector.bounds.minX - (lineWidth + outlineWidth),
                overlayExtents.minX
              ),
              ymin: Math.min(
                connector.bounds.minY - (lineWidth + outlineWidth),
                overlayExtents.minY
              ),
              xmax: Math.max(
                connector.bounds.maxX + (lineWidth + outlineWidth),
                overlayExtents.maxX
              ),
              ymax: Math.max(
                connector.bounds.maxY + (lineWidth + outlineWidth),
                overlayExtents.maxY
              ),
            };
    ...
    var _type =
      params.type ||
      self.endpoints[0].connectionType ||
      self.endpoints[1].connectionType;
    if (_type) self.addType(_type, params.data, _jsPlumb.isSuspendDrawing());
...
(function () {
  ...
  jsPlumb.Segments = {
    ...
    Arc: function (params) {
      ...
      this.segment = jsPlumbUtil.segment(
        [this.x1, this.y1],
        [this.x2, this.y2]
      );
  ...
  jsPlumb.Connectors.AbstractConnector = function (params) {
    ...
    var _prepareCompute = function (params) {
      ...
      var segment = jsPlumbUtil.segment(params.sourcePos, params.targetPos),
        ...
        so =
          params.sourceEndpoint.anchor.orientation ||
          params.sourceEndpoint.anchor.getOrientation(params.sourceEndpoint),
        to =
          params.targetEndpoint.anchor.orientation ||
          params.targetEndpoint.anchor.getOrientation(params.targetEndpoint),
    ...
    this.compute = function (params) {
      if (!edited) paintInfo = _prepareCompute(params);
  ...
  jsPlumb.Endpoints.Image = function (params) {
    ...
    _endpoint.setImage = function (img, onload) {
      ...
      if (self.canvas != null) self.canvas.setAttribute("src", img);
    };
    ...
    this._compute = function (
      ...
      if (self.ready)
        return [
          anchorPoint[0] - widthToUse / 2,
          anchorPoint[1] - heightToUse / 2,
          widthToUse,
          heightToUse,
        ];
      else return [0, 0, 0, 0];
  ...
  var AbstractDOMOverlay = function (params) {
    ...
    var cachedDimensions = null,
      _getDimensions = function (component) {
        if (cachedDimensions == null) cachedDimensions = self.getDimensions();
    ...
    this.draw = function (component, currentConnectionPaintStyle) {
      ...
      if (td != null && td.length == 2) {
        ...
        if (component.pointOnPath) {
          ...
          var locToUse =
            self.loc.constructor == Array ? self.loc : self.endpointLoc;
            ...
            with (paintInfo) {
              var sis = {
                ...
                otherFlipped =
                  ...
                  (to[toIdx] == 1 && otherStubs[axis][1] > otherStubs[axis][0]),
                stub1 = stubs[axis][_so][0],
                stub2 = stubs[axis][_so][1],
                segmentIndexes = sis[axis][_so][_to];

              if (
                segment == segmentIndexes[3] ||
                (segment == segmentIndexes[2] && otherFlipped)
              ) {
                return midLines[axis];
              } else if (segment == segmentIndexes[2] && stub2 < stub1) {
                return linesToEnd[axis];
              } else if (
                (segment == segmentIndexes[2] && stub2 >= stub1) ||
                (segment == segmentIndexes[1] && !otherFlipped)
              ) {
...
(function () {
  ...
  var scale = 1000,
    ...
    _node = function (
      ...
      else jsPlumb.CurrentLibrary.appendElement(o, parent);
    ...
    VmlEndpoint = (window.VmlEndpoint = function (params) {
      ...
      var vml = null,
        self = this,
        opacityStrokeNode = null,
        opacityFillNode = null;
      self.canvas = document.createElement("div");
      self.canvas.style["position"] = "absolute";

      var clazz =
        self._jsPlumb.endpointClass +
        (params.cssClass ? " " + params.cssClass : "");
  ...
  var AbstractVmlArrowOverlay = function (superclass, originalArgs) {
    ...
    this.cleanup = function () {
      if (self.canvas != null)
        jsPlumb.CurrentLibrary.removeElement(self.canvas);
    };
  };
  ...
  var q = {
    ...
    x = function (a, b) {
      for (
        ...
        h[c] = q.subtract(b[c], a);
      for (c = 0; c <= d - 1; c++)
        (e[c] = q.subtract(b[c + 1], b[c])), (e[c] = q.scale(e[c], 3));
      for (c = 0; c <= d - 1; c++)
        for (var n = 0; n <= d; n++)
          m[c] || (m[c] = []), (m[c][n] = q.dotProduct(e[c], h[n]));
      for (c = 0; c <= g; c++)
        k[c] || (k[c] = []), (k[c].y = 0), (k[c].x = parseFloat(c) / g);
      g = d - 1;
      for (h = 0; h <= d + g; h++) {
        c = Math.max(0, h - g);
        for (e = Math.min(h, d); c <= e; c++)
          (j = h - c), (k[c + j].y += m[j][c] * l[j][c]);
      }
      d = b.length - 1;
      k = u(k, 2 * d - 1, f, 0);
      g = q.subtract(a, b[0]);
      m = q.square(g);
      for (c = l = 0; c < k; c++)
        (g = q.subtract(a, v(b, d, f[c], null, null))),
          (g = q.square(g)),
          g < m && ((m = g), (l = f[c]));
      g = q.subtract(a, b[d]);
      g = q.square(g);
      g < m && ((m = g), (l = 1));
      return { location: l, distance: m };
    },
    u = function (a, b, f, d) {
      var g = [],
        h = [],
        ...
        case 1:
          ...
          for (r = 1; r < b; r++)
            (p = k * a[r].x + c * a[r].y + n),
              p > l
                ? (l = p)
                : p < max_distance_below && (max_distance_below = p);
          p = c;
          r = 0 * p - 1 * k;
          l = (1 * (n - l) - 0 * p) * (1 / r);
          p = c;
    ...
    v = function (a, b, f, d, g) {
      ...
      for (a = 1; a <= b; a++)
        for (e = 0; e <= b - a; e++)
          h[a] || (h[a] = []),
            h[a][e] || (h[a][e] = {}),
            (h[a][e].x = (1 - f) * h[a - 1][e].x + f * h[a - 1][e + 1].x),
            (h[a][e].y = (1 - f) * h[a - 1][e].y + f * h[a - 1][e + 1].y);
      if (null != d) for (e = 0; e <= b; e++) d[e] = h[e][0];
      if (null != g) for (e = 0; e <= b; e++) g[e] = h[b - e][e];
      return h[b][0];
    },
    y = {},
    s = function (a, b) {
      ...
      if (!f) {
        ...
        f.push(
          new (function () {
            return function (a) {
              return Math.pow(1 - a, d);
            };
          })()
        );
        y[d] = f;
      }
      for (e = h = g = 0; e < a.length; e++)
        (g += a[e].x * f[e](b)), (h += a[e].y * f[e](b));
      return { x: g, y: h };
    },
    z = function (a, b) {
    ...
    t = function (a, b, f) {
      ...
      for (
        var d = s(a, b), g = 0, h = 0 < f ? 1 : -1, e = null;
        g < Math.abs(f);

      )
        (b += 0.005 * h), (e = s(a, b)), (g += z(e, d)), (d = e);
      return { point: e, location: b };
    },
    w = function (a, b) {
      var f = s(a, b),
        d = s(a.slice(0, a.length - 1), b),
        g = d.y - f.y,
        f = d.x - f.x;
      return 0 == g ? Infinity : Math.atan(g / f);
    };
  window.jsBezier = {
    distanceFromCurve: x,
    gradientAtPoint: w,
    gradientAtPointAlongCurveFrom: function (a, b, f) {
      b = t(a, b, f);
    ...
    nearestPointOnCurve: function (a, b) {
      var f = x(a, b);
      return {
        point: v(b, b.length - 1, f.location, null, null),
        location: f.location,
      };
    },
    pointOnCurve: s,
    pointAlongCurveFrom: function (a, b, f) {
    ...
    getLength: function (a) {
      if (A(a)) return 0;
      for (var b = s(a, 0), f = 0, d = 0, g = null; 1 > d; )
        (d += 0.005), (g = s(a, d)), (f += z(g, b)), (b = g);
      return f;
    },
  };
})();